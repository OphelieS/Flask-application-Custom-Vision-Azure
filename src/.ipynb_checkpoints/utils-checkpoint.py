...
url = "https://cgcustomvision-prediction.cognitiveservices.azure.com/"
api_keys = '33463958a6a048f48c49653b457e0853'
...
def pred_func(data):
    ...
    print(r)
    pred = {x["tagName"]:x["probability"]  for x in json.loads(r)["pred"]}
