...
# Configuration
download_path = "static/images/camera/"
# Images
words_to_search = ['bouteille plastique propre', 'bouteille plastique sale', 'couverts plastiques propres','couverts plastiques sales','gobelet plastique propre','gobelet plastique sale']
nb_to_download = [30,30,30,30,30,30]
...
def search_and_save(text, number, first_position):
    ...
    for _ in range(number_of_scrolls):
        ...
        time.sleep(2.5)
        try:
            driver.find_element(By.XPATH, "////////////button[class='mye4qd']").click()
    ...
    imges = driver.find_elements(By.XPATH, "/////////////////div[contains(class='rg_i.Q4LuWd')]")
